...
- **六阶段 SDLC 流程**：P1 需求分析 → P2 系统设计 → P3 编码实现 → P4 测试验证 → P5 代码审查 → P6 部署交付
...
```
/review                    # 审查所有已修改的文件
/review src/auth/login.ts  # 审查指定文件
```
...
| 阶段 | 名称 | 核心活动 | 允许的关键操作 |
|------|------|---------|--------------|
| **P1** | 需求分析 | 理解需求、分析代码库、识别范围 | 读取代码、搜索资料 |
| **P2** | 系统设计 | 架构设计、技术选型、实现规划 | 读取代码、搜索资料 |
| **P3** | 编码实现 | 编写代码、遵循编码规范 | 读写代码、构建 |
| **P4** | 测试验证 | 编写和执行测试 | 读写代码、执行测试 |
| **P5** | 代码审查 | 四维度审查（质量/安全/性能/可维护性） | 读取代码 |
| **P6** | 部署交付 | Git 提交、创建 PR | Git 操作 |
